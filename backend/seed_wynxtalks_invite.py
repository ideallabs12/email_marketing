"""
Seed script: inserts the WYNx Talks Speaker Invitation email template into the database.
Run inside the backend Docker container:
    docker compose exec backend python seed_wynxtalks_invite.py
"""
import os
import sys
import django
...
TEMPLATE_FILE = Path(__file__).resolve().parent / 'wynxtalks_invite.html'
...
SUBJECT       = "A Conversation Around Your Perspective"
