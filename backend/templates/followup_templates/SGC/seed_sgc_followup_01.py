"""
Seed script: inserts the SGC Follow-up email template into the database.
"""
import os
import sys
import django
...
TEMPLATE_FILE = Path(__file__).resolve().parent / 'sgc_followup_01.html'
...
TEMPLATE_NAME = "SGC_FOLLOWUP_01"
SUBJECT       = "Following up: Speaker Opportunity — Women in Tech Leadership Summit 2027"
