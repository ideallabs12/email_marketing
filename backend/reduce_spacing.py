  ...
  <tr>
    <td align="center" style="padding:20px 16px;">
      ...
      <table role="presentation" class="email-container" width="600" cellpadding="0" cellspacing="0" style="width:600px; max-width:600px; background-color:#FFFFFF; box-shadow:0 4px 28px rgba(29,20,79,0.10);">
        ...
        <!-- LOGO / TOP BAR -->
        <tr>
          <td style="background-color:#1E1544; padding:16px 40px;">
        ...
        <tr>
          <td class="fluid-pad" background="https://tohlagjzvjoqrutolcwf.supabase.co/storage/v1/object/public/email_marketing/mail_header.png" style="background:url('https://tohlagjzvjoqrutolcwf.supabase.co/storage/v1/object/public/email_marketing/mail_header.png') no-repeat center center; background-size:cover; padding:32px 40px 28px 40px;">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="hero-title" style="color:#FFFFFF; font-size:28px; line-height:36px; font-weight:normal; padding-top:12px;">
              ...
              <tr>
                <td class="sans" style="color:#C8BEE0; font-size:13px; letter-spacing:1px; padding-top:10px;">
        ...
        <tr>
          <td class="fluid-pad" style="padding:24px 48px 6px 48px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td class="sans" style="color:#1E1544; font-size:16px; font-weight:bold; padding-bottom:12px;">
                  Dear {{ first_name }},
                </td>
              </tr>
              <tr>
                <td class="sans" style="color:#3B3752; font-size:14px; line-height:22px; padding-bottom:12px;">
              ...
              <tr>
                <td class="sans" style="color:#3B3752; font-size:14px; line-height:22px; padding-bottom:8px;">
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="padding:16px;">
                        <div class="sans" style="color:#9A7A3E; font-size:11px; letter-spacing:2px; text-transform:uppercase; font-weight:bold; padding-bottom:10px;">
                          Event Details
                        </div>
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td class="sans" style="color:#1E1544; font-size:13px; line-height:20px; padding-bottom:4px;">
                              <strong>Date</strong><br>March 08–09, 2027
                            </td>
                          </tr>
                          <tr>
                            <td class="sans" style="color:#1E1544; font-size:13px; line-height:20px; padding-top:6px;">
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="padding:16px;">
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td class="sans" style="color:#3B3752; font-size:12px; line-height:16px; padding-bottom:6px;">
                          ...
                          <tr>
                            <td class="sans" style="color:#3B3752; font-size:12px; line-height:16px;">
        ...
        <tr>
          <td class="fluid-pad" style="padding:16px 48px 8px 48px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#1E1544; border-left:3px solid #D4AF6A; background-image:url('https://tohlagjzvjoqrutolcwf.supabase.co/storage/v1/object/public/email_marketing/mail_footer.png'); background-size:cover; background-position:right center; background-repeat:no-repeat;">
              <tr>
                <td style="padding:16px 16px 16px 20px;" valign="middle">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td valign="middle">
        ...
        <!-- SIGN OFF -->
        <tr>
          <td class="fluid-pad" style="padding:16px 48px 24px 48px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td class="sans" style="color:#3B3752; font-size:14px; line-height:22px;">
        ...
        <!-- FOLLOW / CONTACT BAR -->
        <tr>
          <td style="background-color:#F7F5F1; padding:16px 48px; border-top:1px solid #EFEBE1;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td class="stack sans" style="color:#1E1544; font-size:11px; letter-spacing:1px; text-transform:uppercase; font-weight:bold; padding-bottom:4px;">
                  Follow Us
                </td>
                <td class="stack" align="right" style="padding-bottom:4px;">&nbsp;</td>
              </tr>
              <tr>
                <td class="stack sans" style="font-size:12px;">
                ...
                <td class="stack" align="right" style="font-size:12px;">
        ...
        <!-- FOOTER -->
        <tr>
          <td align="center" style="background-color:#1E1544; padding:16px 40px;">
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" class="sans" style="color:#8B87A0; font-size:11px; line-height:16px;">
...
t.html_content = compact_html
t.save()
print('Template updated with reduced spacing successfully.')
